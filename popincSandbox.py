...
# project per capita withdrawals using regional growth functions estimated outside this work
print('        Calculating future withdrawals per capita...')
...
print('        Calculating per-acre irrigation withdrawals for the 2015 base data...')
