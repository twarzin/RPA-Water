...
GDB_PPT = os.path.join(MAINFOLDER, 'Precip.gdb')
...
try:
    ...
    for xlsx in listExcelFiles:
        ...
        #   This section can be added to the above loop when the script is finished and running.
        #   The Excel files are for input to Water Demand R scripts, and the geodatabase tables are for AGOL.
        ...
        arcpy.conversion.TableToExcel(outTableFinal,
                                      outFinalExcel)
        # Add a section here that exports the table to a Precip gdb for use in AGOL and ArcGIS Pro. ######################################
