...
# Did I lose: EastWest, DP.growth, DP.decay)
...
if(carbon==45 & gcm=="cnrm_c5"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_CNRM_CM5rcp45_month.csv", check.names=F)
}
if(carbon==85 & gcm=="cnrm_c5"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_CNRM_CM5rcp85_month.csv", check.names=F)
}
if(carbon==45 & gcm=="hadgem"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_HadGEM2_ES365rcp45_month.csv", check.names=F)
}
if(carbon==85 & gcm=="hadgem"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_HadGEM2_ES365rcp85_month.csv", check.names=F)
}
if(carbon==45 & gcm=="ipsl_cm5a"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_IPSL_CM5A_MRrcp45_month.csv", check.names=F)
}
if(carbon==85 & gcm=="ipsl_cm5a"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_IPSL_CM5A_MRrcp85_month.csv", check.names=F)
}
if(carbon==45 & gcm=="mri_cgcm3"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_MRI_CGCM3rcp45_month.csv", check.names=F)
}
if(carbon==85 & gcm=="mri_cgcm3"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_MRI_CGCM3rcp85_month.csv", check.names=F)
}
if(carbon==45 & gcm=="noresm"){
  new.precip <-read.csv("1_ClimateData/ClimateData/CountyPrecip/Monthly/pr_NorESM1_Mrcp45_month.csv", check.names=F)
  pet <-read.csv("ClimateData/PET_NorESM_45_Monthly.csv", check.names=F)
    }
if(carbon==85 & gcm=="noresm"){
  new.precip <-read.csv("1_ClimateData/CountyPrecip/Monthly/pr_NorESM1_Mrcp85_month.csv", check.names=F)
