...
try:
    ...
    for file in listDataFiles:
        ...
        # Summarize the Annual Summer PET -------------------------------------
        ...
        fieldList = arcpy.ListFields(tblPET)[4:]
        ...
        # # Name of the output summer PET table
        # #   (example = 'pr_CNRM_CM5rcp45_month_S').
        # nameSummerPET1 = nameDataFile + '_S'
        # outTableSummer1 = os.path.join(
        #     GDB_WORKDIR,
        #     nameSummerPET1)
        # # Define the case field to include in the stats table.
        # caseField = 'Year'
        # # Calculate the annual summer PET ("growing PET" in the R script)
        # #   for each FIPS.
        ...
        # # Name of the transposed summer PET
        # #   (example = 'pr_CNRM_CM5rcp45_month_S_Tx')
        # nameSummerPET2 = nameSummerPET1 + '_Tx'
        # # Full path of transposed summer PET
        ...
        #     fieldAttribute)
        #
        # # Create 'Base' Data Table from the 2015 PET Data ------------------
        # # Same as 's_PET0' in the R script.
        # print(
        ...
        # nameBasePET = nameSummerPET2 + '_Base2015'
        ...
        #     sqlSelectBase)
        #
        # # Add the Base PET Field to the Summer PET Data. ----------------
        # # Format the 'PET' field for the JoinField process.
        # fieldAddPETBase = [fieldValue]
        # # Join by FIPS to add the base PET to the transposed summer
        # #   PET table.
        ...
        # # # List of fields for which to change data type (FIPS and PET data)
        ...
        #     field_mapping=fms)
        #
        # # Change the field alias for 'PET_1' to 'Summer PET Base' -------
        ...
        # #       FIPS, Year, PETSummer, PETSummer_1, ChangeSummerPET.
